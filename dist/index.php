		...
		<div class="row">
			...
			<div class="col-sm-12 col-md-9 col-lg-10">
				...
				<section class="main_banner">
					<div class="banner_arrow_prev">
						<img src="assets/images/slide-prev.svg" alt="Koketka">
					</div>
					<div class="main_banner_slider">
						...
						<div class="banner_item" style="background-image: url(assets/images/banner.jpg);">
							...
							<p>Памучна тениска с къс ръкав и яка на райета.</p>
							<a href="#" class="button_custom">Купить</a>
						</div>
						<!-- Slide END -->
